...
def main():
    ...
    if option=='About':
        ...
        image=Image.open('pics/pic1.png')
        st.image(image,use_column_width=True)
        ...
        st.header('ABHINAV SINGH')
        st.subheader('Machine Learning Intern, Team 8, Technocolab')
        st.subheader('Source Code:-')
        st.write('https://github.com/abhinavsingh1907/toxic_comment_classifier')
